...
ALTER TABLE ohdsi.episode ADD CONSTRAINT episode_pk PRIMARY KEY ( episode_id);
...
CREATE INDEX idx_death_person_id  ON ohdsi.death  (person_id ASC);
CLUSTER ohdsi.death  USING idx_death_person_id ;
