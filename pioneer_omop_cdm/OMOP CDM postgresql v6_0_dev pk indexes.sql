...
ALTER TABLE episode ADD CONSTRAINT episode_pk PRIMARY KEY ( episode_id);

ALTER TABLE episode_event ADD CONSTRAINT episode_event_pk PRIMARY KEY ( episode_id, event_id, event_field_concept_id );
...
CREATE INDEX idx_survey_person_id_1  ON survey_conduct  (person_id ASC);
CLUSTER survey_conduct  USING idx_survey_person_id_1 ;
...
CREATE INDEX idx_episode_person_id_1  ON episode  (person_id ASC);
CLUSTER episode  USING idx_episode_person_id_1 ;
CREATE INDEX idx_episode_concept_id_1 ON episode (episode_concept_id ASC);

CREATE INDEX idx_episode_event_id_1  ON episode_event  (episode_id ASC);
CLUSTER episode_event  USING idx_episode_event_id_1 ;
...
CREATE INDEX idx_cost_person_id_1  ON cost  (person_id ASC);
CLUSTER cost  USING idx_cost_person_id_1 ;
