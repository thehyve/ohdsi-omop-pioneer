-- v2.9.0
-- Created with:
-- https://pioneer.hzdr.de/WebAPI/ddl/results?dialect=postgresql&schema=DELETE_ME&vocabSchema=vocab&tempSchema=temp_schema&initConceptHierarchy=false
-- Then removed results_schema placeholder for it to be set via search_path
